<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminPokerPlay.aspx.cs"
    Inherits="EnjoyWebApplication.TexasHoldem.AdminPokerPlay" %>
...
<body style="font-size: 50px; font-weight: bold;">
    ...
    <div>
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="btnRestart" runat="server" OnClick="btnRestart_Click" Text="重新开始" Font-Size="30px" />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="btnFlop" runat="server" OnClick="btnFlop_Click" Text="翻 牌" Font-Size="30px" />
        <br />
        <br />
        <table>
            <tr>
