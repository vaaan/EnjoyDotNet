<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminPokerPlay.aspx.cs" Inherits="EnjoyWebApplication.TexasHoldem.AdminPokerPlay" %>
...
<body style="font-size: 16px; font-weight: bold;">
    ...
    <div>
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="btnRestart" runat="server" onclick="btnRestart_Click" 
            Text="重新开始" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="btnFlop" runat="server" onclick="btnFlop_Click" Text="翻 牌" />
        <br />
        <br />
        当前公共牌:<br />
        <table style="border-style: solid; border-width: 1px; width: 200px; background-color: #FFFF99;">
            <tr>
